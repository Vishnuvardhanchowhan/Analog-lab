...
filename     = "out_fw.txt"              #filename : This is name of the file containing the x and y values
Plot_Title   =  "Full wave rectifier"
x_axis_label = "time in sec"
y_axis_label = "voltage in V"
number_of_curves_in_plot = 2
legend_list = ["V_out","Vin"]
